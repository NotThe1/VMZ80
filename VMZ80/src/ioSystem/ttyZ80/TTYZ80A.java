...
public class TTYZ80A extends DeviceZ80A implements Runnable {
	...
	private void appClose() {
		Preferences myPrefs = Preferences.userNodeForPackage(TTYZ80A.class).node(this.getClass().getSimpleName());
